            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mx-3 my-3">
                        <div class="card-body">
                            <h1 class="text-center mt-4">Sync Sharepoint to Database: CSS</h1><br>
    ...
    <script>
        $(document).ready(function() {
            ...
            function syncData() {
                ...
                $.ajax({
                    url: 'https://prod-56.southeastasia.logic.azure.com:443/workflows/b6f69aae10ff4542b9634d1135cca0c9/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=NQv1fk5AJjbMuySf-pNMkxSpx3c3hToCrkmX4ah4x8c',
                    method: 'POST',
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            url: 'https://app.italthaiengineering.com/admin_it/css_json_to_sql.php',
                            method: 'POST',
                            contentType: 'application/json',
