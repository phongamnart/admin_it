...
<head>
    ...
    <title>Sync Sharepoint to Database</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mx-3 my-3">
                        <div class="card-body">
                            <h1 class="text-center mt-4">Sync Sharepoint to Database: Patrol</h1><br>
            ...
            function syncData() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            url: 'https://app.italthaiengineering.com/admin_it/patrol_json_to_sql.php',
                            method: 'POST',
                            contentType: 'application/json',
