            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mx-3 my-3">
                        <div class="card-body">
                            <h1 class="text-center mt-4">Sync Sharepoint to Database: CSS tb_contact</h1><br>
    ...
    <script>
        $(document).ready(function() {
            ...
            function syncData() {
                ...
                $.ajax({
                    url: 'https://prod-23.southeastasia.logic.azure.com:443/workflows/a978f71d62fa4f49bdff023c05d5072e/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=gBDqlD7Z-pv1giERewiTcNQYjazlPL1aHfOIn609bbA',
                    method: 'POST',
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            url: 'https://app.italthaiengineering.com/admin_it/css_contact_sql.php',
                            method: 'POST',
                            contentType: 'application/json',
