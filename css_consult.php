            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mx-3 my-3">
                        <div class="card-body">
                            <h1 class="text-center mt-4">Sync Sharepoint to Database: CSS tb_consult</h1><br>
    ...
    <script>
        $(document).ready(function() {
            ...
            function syncData() {
                ...
                $.ajax({
                    url: 'https://prod-18.southeastasia.logic.azure.com:443/workflows/3c5ef85cdc4343b18b89239ccdba42d4/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=Fcz_SD7i28ws9gEl-u7XnhWMVfKG4Sd8Oas0NfjMJT4',
                    method: 'POST',
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            url: 'https://app.italthaiengineering.com/admin_it/css_consult_sql.php',
                            method: 'POST',
                            contentType: 'application/json',
